...
<script src="{{asset('assets/lib/jquery.nanoscroller/javascripts/jquery.nanoscroller.js')}}"></script>
...
<script src="{{asset('assets/lib/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('assets/lib/ckeditor/adapters/jquery.js')}}"></script>
<script src="{{asset('assets/lib/jquery.niftymodals/js/jquery.modalEffects.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/javascript/Ajax/ajax.js')}}"></script>
<script src="{{asset('assets/lib/jquery-ui/jquery-ui.min.js')}}" type="text/javascript"></script>
