...
<script src="{{asset('Material/vendors/bootgrid/jquery.bootgrid.updated.min.js')}}">
</script>
<!-- Placeholder for IE9 -->
<!--[if IE 9 ]>
<script src="{{asset('Material/vendors/bower_components/jquery-placeholder/jquery.placeholder.min.js')}}"></script>
<![endif]-->
...
<script src="{{asset('Material/Validator/bootstrapValidator.js')}}"></script>
<script src="{{asset('Material/vendors/bower_components/autosize/dist/autosize.min.js')}}"></script>
