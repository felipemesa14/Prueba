!function (t, e) {
    ...
    function s(e) {
        var i = this.footer ? this.footer.find(e) : t(), s = this.header ? this.header.find(e) : t();
        return t.merge(i, s)
    }
    ...
    function d() {
        var e = this, i = this.element.find("thead > tr").first(), s = !1;
        i.children().each(function () {
            var i = t(this), o = i.data(), n = {
                id: o.columnId,
    ...
    function u() {
        ...
        if (this.element._bgBusyAria(!0).trigger("load" + j), P.call(this), this.options.ajax) {
            ...
            var h = this.searchPhrase.length > 0 ? this.rows.where(i) : this.rows, d = h.length;
            -1 !== this.rowCount && (h = h.page(this.current, this.rowCount)), e.setTimeout(function () {
                s(h, d)
            }, 10)
        }
    }
    ...
    function p() {
        if (!this.options.ajax) {
            var e = this, s = this.element.find("tbody > tr");
            s.each(function () {
                var s = t(this), o = s.children("td"), n = {};
    ...
    function g() {
        var e = this.options.templates, i = this.element.parent().hasClass(this.options.css.responsiveTable) ? this.element.parent() : this.element;
        this.element.addClass(this.options.css.table), 0 === this.element.children("tbody").length && this.element.append(e.body), 1 & this.options.navigation && (this.header = t(e.header.resolve(o.call(this, {id: this.element._bgId() + "-header"}))), i.before(this.header)), 2 & this.options.navigation && (this.footer = t(e.footer.resolve(o.call(this, {id: this.element._bgId() + "-footer"}))), i.after(this.footer))
    }

    function v() {
        if (0 !== this.options.navigation) {
            var e = this.options.css, i = r(e.actions), n = s.call(this, i);
            if (n.length > 0) {
                var l = this, a = this.options.templates, c = t(a.actions.resolve(o.call(this)));
                if (this.options.ajax) {
                    var h = a.icon.resolve(o.call(this, {iconCss: e.iconRefresh})), d = t(a.actionButton.resolve(o.call(this, {
                        content: h,
    ...
    function m(e) {
        if (this.options.columnSelection && this.columns.length > 1) {
            var i = this, s = this.options.css, n = this.options.templates, l = n.icon.resolve(o.call(this, {iconCss: s.iconColumns})), a = t(n.actionDropDown.resolve(o.call(this, {content: l}))), c = r(s.dropDownItem), d = r(s.dropDownItemCheckbox), p = r(s.dropDownMenuItems);
    ...
    function b() {
        if (0 !== this.options.navigation) {
            var e = r(this.options.css.infos), i = s.call(this, e);
            if (i.length > 0) {
                var n = this.current * this.rowCount, l = t(this.options.templates.infos.resolve(o.call(this, {
    ...
    function w() {
        var t = this.element.children("tbody").first(), e = this.options.templates, i = this.columns.where(h).length;
        this.selection && (i += 1), t.html(e.noResults.resolve(o.call(this, {columns: i})))
    }

    function y() {
        if (0 !== this.options.navigation) {
            var e = r(this.options.css.pagination), i = s.call(this, e)._bgShowAria(-1 !== this.rowCount);
            if (-1 !== this.rowCount && i.length > 0) {
                var n = this.options.templates, l = this.current, a = this.totalPages, c = t(n.pagination.resolve(o.call(this))), h = a - l, d = -1 * (this.options.padding - l), u = h >= this.options.padding ? Math.max(d, 1) : Math.max(d - this.options.padding + h, 1), p = 2 * this.options.padding + 1, f = a >= p ? p : a;
    ...
    function x(e, i, s, n) {
        var l = this, a = this.options.templates, c = this.options.css, h = o.call(this, {
            css: n,
            text: s,
            page: i
        }), d = t(a.paginationItem.resolve(h)).on("click" + j, r(c.paginationButton), function (e) {
            e.stopPropagation(), e.preventDefault();
            var i = t(this), s = i.parent();
            if (!s.hasClass("active") && !s.hasClass("disabled")) {
                var o = {first: 1, prev: l.current - 1, next: l.current + 1, last: l.totalPages}, n = i.data("page");
    ...
    function C(e) {
        ...
        var s = this, n = this.options.rowCount;
        if (t.isArray(n)) {
            var l = this.options.css, a = this.options.templates, c = t(a.actionDropDown.resolve(o.call(this, {content: i(this.rowCount)}))), h = r(l.dropDownMenu), d = r(l.dropDownMenuText), p = r(l.dropDownMenuItems), f = r(l.dropDownItemButton);
    ...
    function D(e) {
        if (e.length > 0) {
            var i = this, s = this.options.css, n = this.options.templates, l = this.element.children("tbody").first(), a = !0, c = "";
            t.each(e, function (e, r) {
                var l = "", h = ' data-row-id="' + (null == i.identifier ? e : r[i.identifier]) + '"', d = "";
                if (i.selection) {
                    var u = -1 !== t.inArray(r[i.identifier], i.selectedRows), p = n.select.resolve(o.call(i, {
                        type: "checkbox",
                ...
                f && (d += f), t.each(i.columns, function (e, a) {
                    if (a.visible) {
                        var c = t.isFunction(a.formatter) ? a.formatter.call(i, a, r) : a.converter.to(r[a.id]), h = a.cssClass.length > 0 ? " " + a.cssClass : "";
                        l += n.cell.resolve(o.call(i, {
                            content: null == c || "" === c ? "&nbsp;" : c,
    ...
    function A(e) {
        var i = this, s = r(this.options.css.selectBox);
        this.selection && e.off("click" + j, s).on("click" + j, s, function (e) {
            e.stopPropagation();
            var s = t(this), o = i.converter.from(s.val());
            s.prop("checked") ? i.select([o]) : i.deselect([o])
        }), e.off("click" + j, "> tr").on("click" + j, "> tr", function (e) {
            e.stopPropagation();
            var s = t(this), o = null == i.identifier ? s.data("row-id") : i.converter.from(s.data("row-id") + ""), n = null == i.identifier ? i.currentRows[o] : i.currentRows.first(function (t) {
    ...
    function k() {
        if (0 !== this.options.navigation) {
            var i = this.options.css, n = r(i.search), l = s.call(this, n);
            if (l.length > 0) {
                var a = this, c = this.options.templates, h = null, d = "", u = r(i.searchField), p = t(c.search.resolve(o.call(this))), f = p.is(u) ? p : p.find(u);
    ...
    function R() {
        var e = this, i = this.element.find("thead > tr"), s = this.options.css, n = this.options.templates, l = "", a = this.options.sorting;
        if (this.selection) {
            var c = this.options.multiSelect ? n.select.resolve(o.call(e, {type: "checkbox", value: "all"})) : "";
            l += n.rawHeaderCell.resolve(o.call(e, {content: c, css: s.selectCell}))
        }
        if (t.each(this.columns, function (t, i) {
                if (i.visible) {
                    var r = e.sortDictionary[i.id], c = a && r && "asc" === r ? s.iconUp : a && r && "desc" === r ? s.iconDown : "", h = n.icon.resolve(o.call(e, {iconCss: c})), d = i.headerAlign, u = i.headerCssClass.length > 0 ? " " + i.headerCssClass : "";
    ...
    function _(t) {
        var e = this.options.css, i = r(e.icon), s = t.data("column-id") || t.parents("th").first().data("column-id"), o = this.sortDictionary[s], n = t.find(i);
        if (this.options.multiSort || (t.parents("tr").first().find(i).removeClass(e.iconDown + " " + e.iconUp), this.sortDictionary = {}), o && "asc" === o)this.sortDictionary[s] = "desc", n.removeClass(e.iconUp).addClass(e.iconDown); else if (o && "desc" === o)if (this.options.multiSort) {
            var l = {};
            for (var a in this.sortDictionary)a !== s && (l[a] = this.sortDictionary[a]);
            this.sortDictionary = l, n.removeClass(e.iconDown)
        } else this.sortDictionary[s] = "asc", n.removeClass(e.iconDown).addClass(e.iconUp); else this.sortDictionary[s] = "asc", n.addClass(e.iconUp)
    }
    ...
    function P() {
        ...
        e.setTimeout(function () {
            if ("true" === t.element._bgAria("busy")) {
                var e = t.options.templates, i = t.element.children("thead").first(), s = t.element.children("tbody").first(), n = s.find("tr > td").first(), r = t.element.height() - i.height() - (n.height() + 20), l = t.columns.where(h).length;
                t.selection && (l += 1), s.html(e.loading.resolve(o.call(t, {columns: l}))), -1 !== t.rowCount && r > 0 && s.find("tr > td").css("padding", "20px 0 " + r + "px")
            }
        }, 250)
    }
    ...
    var j = ".rs.jquery.bootgrid", M = function (e, i) {
    ...
    if (M.defaults = {
            ...
            if (null != this.identifier) {
                if (this.options.ajax); else {
                    ...
                    for (var e, i = [], s = 0; s < t.length; s++) {
                        e = t[s];
                        for (var o = 0; o < this.rows.length; o++)if (this.rows[o][this.identifier] === e) {
            ...
            if (t = t || "", this.searchPhrase !== t) {
                var e = r(this.options.css.searchField), i = s.call(this, e);
                i.val(t)
            }
            ...
            if (this.selection) {
                ...
                for (var i, s, o = []; e.length > 0 && (this.options.multiSelect || 1 !== o.length);)if (i = e.pop(), -1 === t.inArray(i, this.selectedRows))for (s = 0; s < this.currentRows.length; s++)if (this.currentRows[s][this.identifier] === i) {
                    o.push(this.currentRows[s]), this.selectedRows.push(i);
                    break
                }
                if (o.length > 0) {
                    var n = r(this.options.css.selectBox), l = this.selectedRows.length >= this.currentRows.length;
            ...
            if (this.selection) {
                e = e || this.currentRows.propValues(this.identifier);
                for (var i, s, o, n = []; e.length > 0;)if (i = e.pop(), o = t.inArray(i, this.selectedRows), -1 !== o)for (s = 0; s < this.currentRows.length; s++)if (this.currentRows[s][this.identifier] === i) {
    ...
    t.fn.bootgrid = function (e) {
        var i = Array.prototype.slice.call(arguments, 1), s = null, o = this.each(function (o) {
            var n = t(this), r = n.data(j), l = "object" == typeof e && e;
            if ((r || "destroy" !== e) && (r || (n.data(j, r = new M(this, l)), a.call(r)), "string" == typeof e))if (0 === e.indexOf("get") && 0 === o)s = r[e].apply(r, i); else if (0 !== e.indexOf("get"))return r[e].apply(r, i)
        });
